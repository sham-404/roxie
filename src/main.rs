...
mod tests {
    ...
    //
    //         let mut total_moves = engine.board.gen_moves();
    //         engine.with_ordering(Move::NULL, Move::NULL, 0, &mut total_moves);
    //
    //         let mut ordered_moves = MoveList::new();
    //
    //         let mut picked_moves = MoveList::new();
    //
    //         let mut picker = MovePicker::new(Move::NULL, [Move::NULL, Move::NULL], Move::NULL);
    //
    //         for idx in 0..total_moves.len() {
    //             let mv = total_moves.pick_move(idx);
    //             let score = total_moves.score[idx];
    //             ordered_moves.push_with_score(mv, score);
    //         }
    //
    //         while let Some(mv) = engine.pick_next_mv(&mut picker) {
    //             picked_moves.push(mv);
    //         }
    //
    //         if ordered_moves.as_slice() != picked_moves.as_slice() {
    //             println!("{}", fen);
    //             wrong += 1;
    //             println!("expected ordering {:?}", ordered_moves.as_slice());
    //             println!();
    //             println!("ordering we got {:?}", picked_moves.as_slice());
    //             println!();
    //
    //             for i in 0..ordered_moves.len() {
    //                 let mv = ordered_moves.moves[i];
    //                 let score = ordered_moves.score[i];
    //
    //                 println!(
    //                     "move (raw): {:?} \n move: {}\n score: {}\n",
    //                     mv,
    ...
    //     }
    //
    //     println!("wrong ordering founded: {wrong}");
    // }
    ...
    fn split_mv_gen() {
        ...
        for (idx, line) in reader.lines().enumerate() {
            ...
            let total_moves = board.gen_moves();
            let quiet_moves = board.gen_quiet_moves();
            let tactic_moves = board.gen_tactical_moves();
